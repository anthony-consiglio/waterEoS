...
def register(app):
    ...
    def update_settings(palette, cmap, bin_color, spin_color, llcp_color,
        ...
        return {
            ...
            'line_width': float(line_w) if line_w is not None else DEFAULTS['line_width'],
            'phase_line_width': float(phase_lw) if phase_lw is not None else DEFAULTS['phase_line_width'],
